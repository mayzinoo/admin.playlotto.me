...
$result= pg_query($conn, "select contact_no as result ,DATE(created_at) as mydate From plays where user_id='".$id."' Group by Date(created_at) Order By Date(created_at) desc Limit 5");
//echo $result;
if (!$result) {
